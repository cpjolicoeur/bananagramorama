	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'JoinChannel':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{socket: socket}),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _user$project$Main$PhoenixMsg, command)
				};
			case 'SetNewMessage':
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
			...
			case 'ReceiveChatMessage':
				var _p2 = A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Main$chatMessageDecoder, _p0._0);
				if (_p2.ctor === 'Ok') {
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
			...
			case 'SendMessage':
				...
				var _p3 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$push, push$, model.socket);
				var socket = _p3._0;
				var command = _p3._1;
				return {
					ctor: '_Tuple2',
			...
			default:
				var _p4 = A2(_fbonetti$elm_phoenix_socket$Phoenix_Socket$update, _p0._0, model.socket);
				var socket = _p4._0;
				var command = _p4._1;
				return {
					ctor: '_Tuple2',
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Attributes$placeholder('New Message'),
								_elm_lang$html$Html_Events$onInput(_user$project$Main$SetNewMessage),
...
var _user$project$Main$init = {
	...
	_1: _shmookey$cmd_extra$Cmd_Extra$message(_user$project$Main$JoinChannel)
};
